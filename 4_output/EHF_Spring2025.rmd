...
Prior to 2001, the US Internal Revenue Service (IRS) expressed skepticism about firm-controlled charities set up for the benefit of their own workers, fearing that such programs might be used to funnel tax-advantaged compensation to workers or enable tax or accounting fraud.  But a change in the law allowed employer-sponsored non-profit foundations to provide assistance to employees who suffer a "qualified event," which typically include natural disasters, terrorist or military actions, etc. [@noauthor_disaster_2014; @aprill_charitable_2016].  Funds can only be used for basic living expenses (food, clothing, transportation, housing/house repair, burial) for the recipient and immediate family [@noauthor_disaster_2014].
