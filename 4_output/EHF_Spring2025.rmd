...
Prior to 2001, the US Internal Revenue Service (IRS) expressed skepticism about firm-controlled charities set up for the benefit of their own workers.  But a change in the law allowed employer-sponsored non-profit foundations to provide assistance to employees who suffer a "qualified event," which typically include unforeseen events such as natural disasters, house fires, terrorist or military actions, etc. [@noauthor_disaster_2014; @aprill_charitable_2016].  Funds can only be used for basic living expenses (food, clothing, transportation, housing/house repair, burial) for the recipient and immediate family [@noauthor_disaster_2014].

We know very little about EHFs.  There is a small practitioner literature [@noauthor_environmental_2013; @employee_relief_fund_education_group_environmental_2019;@aspen_institute_illuminating_2019; @rodriguez_creating_2020;@rodriguez_every_2020], but scholarly attention has been minimal and oblique^[@amorim_schedule_2022; @reich_working_2018 are the only two peer-reviewed pieces mentioning EHFs of which I am aware.] Relying on interviews with EHF grant recipients, aggregated data on grant disbursement amounts, and anecdotes about best practices, these reports focus on documenting how EHF grants helped recipients in need.  None of the existing studies reports basic descriptive information (such as employee awareness and engagement rates) nor do they document overall effects among the workforce.  There is no comparison between grant recipients and non-recipients suffering similar hardships nor any effort to address selection into grant application, receipt, or the study.  Realistically, only a tiny minority of a firm's workforce is likely to apply for, much less receive, an EHF grant.  To look for broader effects on a firm's workforce, I look to the presence of EHF program and publicity around it. 
...
Table \@ref(tab:tab-attachment-models-wmt) summarizes findings. As in Study 2, we continue to see that those pre-exposed to the EHF are more attached to their jobs, even after conditioning on predictors of EHF awareness. But experimental findings around the ACNT differ: the video treatment has small positive effect that is indistinguishable from zero at conventional thresholds.   
