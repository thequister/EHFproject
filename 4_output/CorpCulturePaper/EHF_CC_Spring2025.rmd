...
Lots of work on CSR and how it connects to stakeholders, including workers.  But this largely focuses on corporate charitable programs up to and including management-organized pro-bono and "pro social" activities.  Work has Signalling culture, making meaning EHFs connect to ongoing debates in the management literature about whether and how corporate social responsibility (CSR) efforts support a strong corporate culture across a widely distributed and sometimes low-paid workforce [@turbanCorporateSocialPerformance1997; @gorton_corporate_2020; @hayton_little_2012; @brekkeAttractingResponsibleEmployees2008].   increase workers' affective attachment to one another and their employers [@ruppEmployeeReactionsCorporate2006],  improve retention [@bodeCorporateSocialInitiatives2015; @greeningCorporateSocialPerformance2000; @portocarreroEffectsShortTermCorporate2024], and even elicit increased effort [@burbanoGettingGigWorkers2021].  @zhaoInfluenceCorporateSocial2022
...
EHFs present a tractable, unexploited context to study important questions in the social sciences and management.  EHFs present a well-defined intervention for studying  whether "private governance" initiatives actually benefit workers themselves [@anderson_private_2017; @ahlquist_firm_2020; @locke_promise_2013; @malesky_chains_2018; @distelhorst_does_2017; @mazumderWhatAmericansWant2024].      And EHFs connect with the vibrant cross-disciplinary literature on worker support for unionization [@ahlquistRiseUnionCurious2024; @kochanWorkerVoiceAmerica2019].
