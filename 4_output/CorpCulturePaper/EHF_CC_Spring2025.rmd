...
Studies 2 and 3 involve two survey experiments, conducted with workers at the Home Depot and Walmart—-large retailers with different corporate cultures as well as longstanding but differently structured EHFs--to identify how EHF messaging affects workers’ subjective financial security, job attachment, and support for unionization.  These studies use novel social media recruitment strategies and are the first to exploit actual employer messages about EHFs as experimental treatments.  Messages about generous and well-promoted programs, as at Home Depot, increase job attachment and reduce support for unionization, particularly among workers previously unaware of the program. In contrast, a less generous and less visible program, as at Walmart, produces negligible and sometimes opposite effects. But in neither context do EHFs significantly affect workers’ perceived financial security, contrary to the programs' purported intentions.

These findings provide the first systematic evidence on inward-oriented CSR in the form of Employee Hardship Funds, an increasingly common but under-studied set of programs in the U.S.  But the differences between the Home Depot and Walmart also suggest that, just as with outwardly-oriented CSR, the effects of inward-oriented CSR on workers depend on both the nature of the program itself as well as other corporate practices, norms, and messages that form a corporate culture. While EHFs can function as tools of corporate governance, such effects are neither automatic nor universal. 

Finally, this study is, to my knowledge, the first to link CSR and support for unions.  Most research on union avoidance emphasizes either employer attempts to preempt unionization by improving wages and benefits or employers' use of captive audience meetings, threats, and retaliatory firings during the unionization drives that do occur [@taschereau-dumouchelUnionThreat2020; @farberNonunionWageRates2005; @bronfenbrennerIntensificationEmployerOpposition2009; @laferFearWorkAccount2020; @stansburyUSFirmsHave2021]. Findings here suggest there is scope for inward-oriented CSR--in the form of EHFs--to reduce support for unionization, but these effects depend greatly on execution and, even then, have limits.  There is also a renewed emphasis on mutual aid as a basis for rebuilding worker solidarity [@hertel-fernandez_why_nodate; @jarley_unions_2005; @horowitz_mutualism_2021]. EHFs can clearly play a role here, although there is no evidence that unions and management have explored EHFs as a potential area of common interest.
...
The Home Depot and Walmart are two of the largest retailers in the world, with approximately 420,000 and 1.6 million 2024 US employees, respectively. These firms compete to some degree in both product and labor markets and both have seen union activism. Their job benefits, programs, and procedures have an impact on the retail industry as a whole as well as the communities surrounding their establishments [@wiltshireWalmartSupercentersMonopsony2023; @derenoncourtVoluntaryMinimumWages2025].
...
Employers continue to offer wages and other amenities to pre-preempt unionization, undermine unionization drives, and prevent workers from defecting to competitors  [@jacobyModernManorsWelfare1998;@bronfenbrenner_2009;@kochan_us_2022;@rosenTradeUnionPower1969; @taschereau-dumouchelUnionThreat2020; @ahlquist_ARPS_2017; @bacharach_mutual_2018; @derickson_workers_1988; @quadagno_transformation_1988].  But with union power declining and the advent of distributed supply chains, employers face reduced incentives to make the long term investments of the past.  EHFs are a potentially attractive compromise.  They appear to address a real need but monetary commitments from the employer are low and discretionary.  Operations can be outsourced and grant awards can be adjusted at will to match resources, with little fanfare or oversight.  Funds come, in part, from workers themselves and contributions to the fund, especially from higher-paid executives, are treated as tax-deductible charitable donations. 

## CSR and stakeholders

EHFs connect directly with an active research program exploring how corporate social responsibility (CSR) initiatives shape stakeholder perceptions and behavior. There is work considering how CSR influences investors and consumers [@godfreyRelationshipCorporateSocial2009; @smithEvaluatingImpactCorporate2009]. But CSR is increasingly understood as an important corporate governance mechanism, influencing workers’ attachment, motivation, and identification with the firm [@ruppEmployeeReactionsCorporate2006; @turbanCorporateSocialPerformance1997].  

CSR can influence workers through multiple pathways.  For example, CSR activities can signal a firm’s values and culture. By broadcasting a commitment to pro-social activities, firms may attract and retain workers value-aligned workers or interpret CSR signals as reflecting a respectful and supportive workplace [@brekkeAttractingResponsibleEmployees2008; @gorton_corporate_2020; @hayton_little_2012]. These signals are especially important in large firms with widely distributed workforces. In such settings, shared values and symbolic gestures play a central role in shaping perceptions of organizational culture [@kampkotter_employee_2020].

Worker-directed CSR can also affect **retention, affective attachment, and effort**. Employees exposed to pro-social messaging about their employer report stronger firm identification, greater attachment to coworkers, and increased willingness to go beyond formal job requirements [@bodeCorporateSocialInitiatives2015; @burbanoGettingGigWorkers2021]. For example, @burbanoGettingGigWorkers2021 finds that even in gig work settings, CSR messaging increases unpaid effort, suggesting that workers respond to perceived moral alignment with their employer.

However, the **effects of CSR are contingent** on how workers interpret managerial motives. Recent studies show that positive effects depend on consistency with broader management practices. When CSR messages are paired with actions that signal distrust or control, such as increased surveillance, they may fail or even backfire [@burbanoMitigatingGigRemote2022]. Similarly, @cassarIntentionsDoingGood2021 demonstrates that employees respond more positively when CSR initiatives appear sincere rather than strategic or insincere.

These studies converge on a central insight: **workers interpret CSR within a broader context of organizational signals**—including pay, scheduling, staffing, and autonomy. In low-wage and high-turnover environments, such as retail, where workers often report feeling undervalued or disposable, CSR must be especially well-integrated and authentic to be effective [@ahlquist_firm_2020; @weil_fissured_2014].

Yet, when aligned with credible management practices, worker-directed CSR can foster a sense of **mutual obligation and solidarity**. Research on mutual aid and private welfare suggests that collective experiences of support—particularly in the form of shared programs or institutions—can promote a sense of belonging and interdependence among otherwise disconnected workers, developing a sort of "community of fate" [@ahlquist_interest_2013; @ismay_trust_2018].

**Employee Hardship Funds (EHFs)** are a novel and understudied form of worker-directed CSR. Unlike typical CSR programs, EHFs are inward-facing: they provide emergency cash assistance to employees, often funded in part by employee donations and administered by the firm. These programs have historical precedents in 20th-century welfare capitalism [@brandesAmericanWelfareCapitalism1976; @jacobyModernManorsWelfare1998] but have re-emerged in today’s private sector as a response to rising precarity and limited public safety nets.

EHFs may serve multiple purposes: offering tangible benefits to vulnerable workers while also **signaling care, community, and commitment**. Promotion of EHFs often draws on moral rhetoric—emphasizing solidarity, shared hardship, and the firm’s human values. However, consistent with the broader CSR literature, the effectiveness of EHFs likely hinges on their **design, generosity, visibility, and alignment** with other corporate practices.

Given these insights, we propose the following hypotheses:

### Hypotheses

- **H1 (Attachment):** Exposure to EHF information increases workers’ affective attachment to their employer and coworkers, especially when the program is perceived as generous and well-promoted.

- **H2 (Contingency):** The effects of EHF messaging on attachment are moderated by prior awareness and employer credibility. Increases in attachment will be larger among workers who were previously unaware of the EHF and who perceive management as respectful and fair.

- **H3 (Union Support):** Exposure to EHF messaging reduces support for unionization among workers who view the program as generous, trustworthy, and aligned with corporate values.

- **H4 (Perceived Solidarity):** EHF messaging increases the perceived likelihood that coworkers would support unionization, particularly among workers who interpret the EHF as a sign of mutual aid and shared experience.

These hypotheses reflect the dual nature of EHFs: as tangible benefits and as symbolic signals. Their effects depend not only on content but on context—how workers interpret employer motives and how the program fits within the firm’s broader culture.
