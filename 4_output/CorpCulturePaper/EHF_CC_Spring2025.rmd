...
These findings break new empirical ground and provide a needed baseline for further study of EHFs and other "private welfare" initiatives.  But the differences between the Home Depot and Walmart also suggest that, just as with outwardly-oriented CSR, the effects of inward-directed CSR on workers depend on both the nature of the program itself as well as other corporate practices, norms, and messages that form a corporate culture.  The EHF treatment enhanced worker attachment at the Home Depot but produced no effect at Walmart. 

Findings also speak to the process of union avoidance and---perhaps---rebuilding.  Most research on union avoidance emphasizes employers' use of wage increases and benefit improvements to preempt unionization as well as captive audience meetings, threats, and retaliatory firings during unionization drives [@taschereau-dumouchelUnionThreat2020; @farberNonunionWageRates2005; @bronfenbrennerIntensificationEmployerOpposition2009; @laferFearWorkAccount2020; @stansburyUSFirmsHave2021].  EHFs broadens the discussion .  Findings here suggest there is scope for EHF programs to reduce support for unionization, but these effects depend greatly on execution and, even then, have limits.  The comparison of the Home Depot and Walmart suggests that spinning up an EHF in the midst of a unionization drive may be viewed by some workers as a cynical ploy, than to displace interest in unions.

More broadly, this research contributes to understanding the contingent role of private welfare initiatives in shaping workplace solidarities and labor politics. While EHFs can be used as tools of union avoidance, their effectiveness depends greatly on execution and context—and poorly executed efforts may be viewed as insincere. These findings broaden the literature on CSR and corporate culture and suggest new avenues for research on the evolving “moral economy” of the U.S. workplace.


######

Lots of work on CSR and how it connects to stakeholders, including workers.   What happens when the beneficiaries of corporate CSR activities are the firm's own workers? But this largely focuses on corporate charitable programs up to and including management-organized pro-bono and "pro social" activities.  Work has Signalling culture, making meaning EHFs connect to ongoing debates in the management literature about whether and how corporate social responsibility (CSR) efforts support a strong corporate culture across a widely distributed and sometimes low-paid workforce.  CSR activities can be signals that help screen for protential empoyees  [@turbanCorporateSocialPerformance1997; @gorton_corporate_2020; @hayton_little_2012; @brekkeAttractingResponsibleEmployees2008].   increase workers' affective attachment to one another and their employers [@ruppEmployeeReactionsCorporate2006],  improve retention [], and even elicit increased effort [@burbanoGettingGigWorkers2021].  @zhaoInfluenceCorporateSocial2022
...
Since 2001, US Internal Revenue Service (IRS) rules allow employer-controlled non-profit foundations to provide direct cash assistance to employees who suffer a "qualifying event," which typically include unforeseen events such as natural disasters, house fires, terrorist or military actions, etc. [@noauthor_disaster_2014; @aprill_charitable_2016].  Funds can only be used for basic living expenses (food, clothing, transportation, housing/house repair, burial) for the recipient and immediate family [@noauthor_disaster_2014].
...
Beyond the descriptive quantities just outlined, the survey experiments described below will speak to the following hypotheses, emerging from the interviews and the literatures on corporate culture and CSR and unionization reviewed above:
 ...
 3. EHF may be viewed as "private insurance", which could dampen support for unionization. Prompting workers with information about their employer's EHF will reduce workers' willingness to vote for unionization and reduce stated support for government aid programs for unemployment or emergencies.
