...
CSR is increasingly understood as an important corporate governance mechanism, influencing workers’ attachment, motivation, and identification with the firm through multiple pathways [@ruppEmployeeReactionsCorporate2006; @turbanCorporateSocialPerformance1997].  Workers appear place a high value on corporate culture and firms go to lengths to communicate values and culture to prospective employees [@huangCommunicatingCorporateCulture2024]. CSR activities can be one such signal. By broadcasting a commitment to pro-social activities, firms may attract and retain value-aligned workers or workers may interpret CSR signals as reflecting a respectful and supportive workplace [@brekkeAttractingResponsibleEmployees2008; @gorton_corporate_2020; @hayton_little_2012]. These signals are especially important in large firms with widely distributed workforces. In such settings, shared values and symbolic gestures play a central role in shaping perceptions of organizational culture at scale [@akerlofIdentityEconomicsHow2010].

Worker-directed CSR can also affect **retention, affective attachment, and effort**. Employees exposed to pro-social messaging about their employer report stronger firm identification, greater attachment to coworkers, and increased willingness to go beyond formal job requirements [@bodeCorporateSocialInitiatives2015; @burbanoGettingGigWorkers2021]. For example, @burbanoGettingGigWorkers2021 finds that even in gig work settings, CSR messaging increases unpaid effort, suggesting that workers respond to perceived moral alignment with their employer.  @kampkotterEmployeeIdentificationWages2021 show that greater affective attachment to the employer leads to less job search, worker and turnover, and slower wage growth.
...
These studies converge on a central insight: **workers interpret CSR within a broader context of organizational signals**—including pay, benefits, scheduling, staffing, and autonomy. In low-wage and high-turnover environments, such as retail, where workers often report feeling undervalued or disposable, CSR must be especially well-integrated and authentic to be effective [@ahlquist_firm_2020; @weil_fissured_2014].
