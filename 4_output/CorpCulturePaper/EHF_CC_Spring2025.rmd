...
Finally, I asked respondents who did not report having an EHF how much control workers _should_ have if their employer launched an EHF program.^[I have not found any EHF in which representatives of frontline workers have a say in directing the fund.]  Figure \@ref(fig:fig-genpop-control) indicates that large majorities preferred an EHF arrangement in which workers have a voice in running the fund, consistent with work showing strong latent demand for more influence over the terms and conditions of worki [@mazumderWhatAmericansWant2024; @kochanWorkerVoiceAmerica2019] .  The modal response is a shared governance model including both employers and workers representatives.
...
As my preferred measure of awareness, I presented respondents with a list of eight work-related benefits or programs and asked them to indicate all of the ones that the Home Depot made available "workers like you."^[I discuss two other indicators of awareness and compare them with the preferred "list" measure in Appendix \@ref(app-HFaware).]  They were Among the possible programs was "cash grants to help in times of emergency."  The proportion of respondents selecting this answer provides a measure for EHF awareness available for all survey respondents without contaminating the later survey experiment.  I estimate that `r 100*round(aware_tab$aware.prop.l,2)`% (se = `r 100*round(aware_tab$aware.prop.l_se,2)`%) were aware of a cash grant program.  
...
I included a randomized experiment in the survey. The experiment in Study 2 consisted of a control condition and two treatment conditions, referred to as the _text_ and _video_ treatments, respectively.  Respondents in the control arm saw no prompt or mention of the EHF.  
...
Based on results from the Home Depot survey, I avoid the neutral text treatment and concentrate on a video vignette treatment for the Walmart sample.  Unfortunately, Walmart does not produce video or other testimonials about the ACNT.  In fact, the stark difference between the Home Depot and Walmart in EHF media visibility is itself and indicator of the corporate investment and culture around the program.    
