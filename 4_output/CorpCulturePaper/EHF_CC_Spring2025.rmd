...
Second, EHFs are potentially accessible to hourly, part-time, and contract workers.  This sets EHFs apart from other benefits and labor protections that only accrue to directly-employed workers, especially those working full-time or in salaried positions. The increasingly "fissured" workplace may save some labor-related costs in the near term, but pose additional challenges [@tonWhyGoodJobs2012]. EHFs may represent one avenue by which firms can direct some benefits to their workers--perhaps improving morale and blunting public criticism--while retaining the savings that make non-standard labor contracting attractive.
