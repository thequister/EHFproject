...
Finally, by analyzing inward-directed CSR, this study broadens the discussion on union avoidance and---perhaps---rebuilding.  Most research on union avoidance emphasizes employer attempts to preempt unionization with wage increases and benefit improvements while also deploying captive audience meetings, threats, and retaliatory firings during the unionization drives that do occur [@taschereau-dumouchelUnionThreat2020; @farberNonunionWageRates2005; @bronfenbrennerIntensificationEmployerOpposition2009; @laferFearWorkAccount2020; @stansburyUSFirmsHave2021]. Findings here suggest there is scope for EHF programs to reduce support for unionization, but these effects depend greatly on execution and, even then, have limits.
...
The examples above also illustrate how EHFs vary across firms in virtually all programmatic aspects including longevity, eligibility requirements, application procedures, grant generosity and frequency, funding structure, and even whether they are managed in-house or out-sourced to third parties. Although all EHFs have a mutual aid component, communication around the programs also varies in tone and intensity.  Some firms, such as the Home Depot, aggressively promote their EHF programs, including through dedicated social media and YouTube channels as well as regular donation drives.  Others, such as Walmart, appear to put substantially less effort into promoting their program. And messaging varies, sometimes emphasizing charitable motivations, sometimes emphasizing solidarity with co-workers, and sometimes framing the EHF as more of a job amenity.
...
Regardless of current EHF exposure, large majorities of respondents admitted their ignorance as to which retail employers offered EHF programs. Nevertheless, respondents who report an EHF at their current job are less likely to express ignorance and much more likely to offer the (correct) EHF response for the Home Depot and, especially, Walmart.  Overall, these findings suggest that retail workers do not attend strongly to EHFs at the largest employers.
