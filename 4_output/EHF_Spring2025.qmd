...
more impactful...If you get up into the into the multi thousands like you're only helping a couple of people per year. #6
...
I fielded an original survey using the Cloud Research incentivized panel, targeting US respondents 18+ employed in the retail industry.^[In the pre-registered study, we planned a survey of Costco workers, as Costco is the only major retailer without an EHF.  It proved impossible to recruit a sample of Costco workers, so I turned to a study of general retail workers.  Measurement and analysis of the survey follows the pre-registered plan.]  Of those targeted, only respondents with US IP addresses, who passed a screening question confirming employment in the retail industry, and who successfully passed two different attention check questions were allowed to complete the survey.  Respondents with duplicate IP addresses reporting identical demographic values were also excluded.  The survey was in the field from XX - XX 2025 and produced `r nrow(genpop)` valid responses.  Using the 2024 ACS-reported demographics for US adults working in retail, we constructed post-stratification weights based on gender, race, and education.    
...
We asked respondents which of a list of benefits and programs they had at their current retail job.  The EHF response on this list is "emergency cash support." We find that `r round(100*genpop_aware_tab$got.ehf.prop)`% (se = `r 100*genpop_aware_tab$got.ehf.prop_se`) report that their current employer offers emergency cash support and  `r round(100*genpop_aware_tab$aware.prior.prop)`% (se = `r 100*genpop_aware_tab$aware.prior.prop_se`) said that they had heard of EHF programs prior to taking the survey. By way of comparison, in a separate, Fall 2022 survey of front line workers in five industries (including retail), we asked respondents about programs and benefits available at their main job using the same method [@AGT_youngworkers; @WERNsurvey2023].  Twelve percent (12%) of that sample and 13% of retail workers reported that their employer had an emergency cash grant program.  

To evaluate the breadth and accuracy of retail workers' knowledge of EHFs, I presented respondents with a definition of EHF programs and then asked them to state whether each of six large retail employers had an EHF.^[The employers were Costco (no), Disney (yes), Home Depot (yes), Kohl's (yes), Walmart (yes).]

Overall, these findings indicate that retail workers'  exposure to EHFs is relatively modest.  Their knowlege of the programs seems superficial, given the weak ability to identify .
...
To answer more detailed questions about EHF awareness and engagement as well as conduct meaningful survey-based experiments, I fielded an original survey of workers at a large US retailer, The Home Depot.  The Home Depot operates nationwide and reports 418,000 "associates" in the US in 2022, making it feasible to recruit a sizable survey sample [@THD_AR_2022].  The Home Depot's EHF--The Homer Fund--is among the oldest known; it has been in continuous operation since 1999 and it is managed in-house.  HF is among the more generous programs, with a maximum grant amount of \$10,000 and the ability to apply repeatedly (conditional on a qualifying emergency).  The HF is a sizable program, reporting disbursements of \$21.2 million to over 12,000 workers in the 2022 fiscal year [@THD_ESG_2022].  The fund claims that it has disbursed $230 million to 164,000 employees between inception and 2022.  Most importantly for my purposes, The Home Depot maintains an aggressive internal outreach and marketing effort to solicit worker donations and engagement with the Homer Fund.  The HF has a dedicated website and YouTube channel with numerous professional-quality testimonial videos, along with active social media accounts aimed at workers.  The Home Depot runs regular donation drives in which different stores compete with one another to generate participation and donation dollars for the EHF.  The HF prides itself on worker participation; their website states that a "majority of contributions" come from "associates."^[[https://corporate.homedepot.com/page/homer-fund-0](https://corporate.homedepot.com/page/homer-fund-0)]  
...
Do the results from Study 2 replicate at other large US retailers?  Or is the Home Depot something of an outlier?  Based on the results from Study 2, we conducted a third study, this time focusing on Walmart workers.  As another publicly traded, "big box" retailer, work practices and conditions at Walmart will be similar to the Home Depot. The two firms compete to some degree, including over workers.  Walmart has also seen union activism in some locations. Walmart is the largest retailer (and private sector employer) in the United States, over three times as large the Home Depot in employee headcount, making the social media recruitment strategy feasible.  With its size and ubiquity, Walmart job benefits, programs, and procedures have an impact on the retail industry as a whole. 
...
In fielding a survey of Walmart workers, I followed the same social media recruitment strategy as with the Home Depot.  Survey completers were offered the opportunity to enter a raffle for a $400 gift card.  The survey was in the field from XXX to XXX and produced `r nrow(wmt)` complete responses that passed screener and attention checks.  We produce raking weights for the Walmart sample in a manner analogous to the Home Depot and employ them below in the same way.  Survey descriptives by treatment status appear in Appendix XX.
...
aware_tab_wmt<-summarise(wmt_wgt_f, 
...
I construct an index of job attachment by conducting a principal components analysis of the four questions for job attachement, scaled so that larger values indicate greater attachment.^[The questions were loyalty to coworkers, loyalty to employer, willingness to recommend employer, and likelihood of looking for a new job in the next 3 months (revese coded).  The first principal component captured XX% of the variation across these variables.]  I then use the first principal component as the attachment index; analyzing the individual components separtely does not alter qualitative conclusions.  
