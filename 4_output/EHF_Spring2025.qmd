...
By way of comparison, in a separate, Fall 2022 survey of front line workers in five industries (including retail), we asked respondents about programs and benefits available at their main job using the same list method [@AGT_youngworkers; @WERNsurvey2023].  Twelve percent (12%) of that sample and 13% of retail workers reported that their employer had an emergency cash grant program.  Awareness at the Home Depot seems exceptionally high.      
...
Taken together with the awareness results and consistent with the messaging around the Homer Fund donation drives, it appears that Home Depot workers are aware of a charitable endeavor that relates to their coworkers.  But worker awareness of the program's _benefit_ function appears relatively thin.
