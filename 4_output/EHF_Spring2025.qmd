...
As expected, EHF awareness and engagement is substantially lower among the Walmart sample than among the Home Depot workers.  
...
To summarize I construct an attachment index by taking the first principal component from a principal components analysis of the four questions, scaled so that larger values indicate greater attachment.^[The questions were loyalty to coworkers, loyalty to employer, willingness to recommend employer, and likelihood of looking for a new job in the next 3 months (revese coded).  The first principal component captured XX% of the variation across these variables.]  We analyze the various components of the attachment in  that  
