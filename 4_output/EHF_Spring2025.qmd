...
> I think [executives and owners] felt like investing in the [EHF] was a way for them to alleviate a little bit of the pain for the workforce that they were laying off sort of en masse in the late 90s and early 2000s #1

> In the late 90s, after a hurricane came through...the CEO at the time wanted to know why we weren't, you know, doing something for the employees. And so my, um, my boss...did the research into it and kind of got a good understanding of how it would work and, uh, basically helped write the bylaws and, um, protocols around how we would issue grants.  #3
...
> [The employees] love their program so much. It's so built into the culture of belonging and giving and take care. And so I think when it gets that closely tied, they continue to give resources to make sure that they can care for folks. #3 

> There's wide variability in purpose. Also, I mean, you know, on one end of the spectrum it could just be used as like a quantitative retention tool, and on the
other end is, you know, to contribute to a social good. And you know, a lot of both. #6

### "ESG" concerns

There are other ends that EHFs might serve alongside charitable motivations or team-building functions. One is investor relations [@godfreyRelationshipCorporateSocial2009].  "Environment, Social, and Governance" (ESG) became something of a corporate fad in the late 2010s, spawning numerous mutual funds and other investment vehicles that claim to channel resources toward companies that meet particular standards for sustainability, stakeholder respect, and corporate governance.  This, in turn, has created a whole slew of ESG ratings, with various levels of transparency and disclosure.  Whether EHFs succeed in is unclear.  But several major retailers, including the Home Depot, Kohl's, and Walmart aggressively promoted their EHFs in their ESG reports [@THD_ESG_2022]. Author interviews with EHF professionals confirm that some of the recent interest in EHFs stems from the hope that EHF programs will help with investor relations and "count" in the "S" bucket when large investors and fund managers evaluate a company's ESG performance.

> So strategic reasons, CSR, what does that look like? We want to get into ESG. Okay, great...from a social standpoint, as well as the disaster preparedness, but definitely from a social standpoint people are trying to make the case that these programs will fall under those buckets. #2

> The [ESG] metrics are very murky...The first few years, some people were trying to fit [the EHF] into environmental because of climate disasters, that it was a response to climate disasters, but the metric piece really gets into the social and then of course the governance...But a huge driver for us to was how to really have more integrity around telling people that they could have the metrics for checking the box if they didn't really know if it was helping their people or not. #3
...
> We've capped our grants at 750 bucks right now. And so the the thinking behind that is, go go wider with more people as opposed to deeper and
more impactful...If you get up into the into the multi thousands like you're only helping a couple of people per year.
...
I fielded an original survey on the Cloud Research incentivized panel, targeting US respondents 18+ employed in the retail industry.  Of those targeted, only respondents with US IP addresses, who passed a screening question confirming employment in the retail industry, and who successfully passed two different attention check questions were allowed to complete the survey.  Respondents with duplicate IP addresses reporting identical demographic values were also excluded.  The survey was in the field from XX - XX 2025 and produced `r nrow(genpop)` valid responses.  Using the 2024 ACS-reported demographics for US adults working in retail, we constructed post-stratification weights based on gender, race, and education.    



By way of comparison, in a separate, Fall 2022 survey of front line workers in five industries (including retail), we asked respondents about programs and benefits available at their main job using the same list method [@AGT_youngworkers; @WERNsurvey2023].  Twelve percent (12%) of that sample and 13% of retail workers reported that their employer had an emergency cash grant program.  
...
To answer more detailed questions about EHF awareness and engagement as well as conduct meaningful survey-based experiments, we fielded an original survey of workers at one large, non unionized US retailer, The Home Depot.  The Home Depot is an attractive case for numerous reasons.  It operates nationwide and reports 418,000 "associates" in the US in 2022, making it feasible to recruit a sizable survey sample [@THD_AR_2022]. It enters the National Retail Federation's ranking of retailers at number five by revenue.  The Home Depot's EHF--The Homer Fund--is among the oldest known; it has been in continuous operation since 1999 and it is managed in-house.  It is also among the more generous programs, with a maximum grant amount of \$10,000 and the ability to apply repeatedly (conditional on a qualifying emergency).  The Homer Fund is a sizable program, reporting disbursements of \$21.2 million to over 12,000 workers in the 2022 fiscal year [@THD_ESG_2022].  The fund claims that it has disbursed $230 million to 164,000 employees between inception and 2022.  Most importantly for my purposes, The Home Depot maintains an aggressive internal outreach and marketing effort to solicit worker donations and engagement with the Homer Fund.  The Homer Fund manages a dedicated website and YouTube channel with numerous professional-quality testimonial videos along with active social media accounts aimed at workers.  The Home Depot runs regular donation drives in which different stores compete with one another to generate participation and donation dollars for the EHF.  And the Homer Fund prides itself on worker participation; their website states that a "majority of contributions" come from "associates."^[[https://corporate.homedepot.com/page/homer-fund-0](https://corporate.homedepot.com/page/homer-fund-0)]  I exploit these corporate outreach messages in the survey experiment described below.  

The Home Depot is clearly not representative of all firms or even all firms that maintain EHFs.  It is larger and puts more effort and resources behind its EHF, having done so for longer than most firms.  I therefore view the Home Depot as a extreme case.  Interviews with EHF practitioners suggest that worker awareness at the Home Depot likely approaches the upper bound of what is achievable among US retail employers.

## The sample and survey

Constructing a matched worker-employer survey sample is quite challenging.  In designing this study, I follow @schneider_whats_2019 and recruit participants through ads on the Facebook and Instagram platforms targeted at users 18 and older with Facebook-reported status as Home Depot employees.  Those completing the survey were offered entry into a raffle for a free iPad Mini.  @schneider_whats_2019 show that this strategy has considerable promise, providing accurate estimates of the employee population of a large number of retail firms.  But the Facebook strategy has the primary drawback of sample selection.  To some degree this is unavoidable.  But to partially mitigate selection concerns,  I follow @schneider_whats_2019 and construct raking weights using the Facebook-reported gender and age distributions for Facebook/Instagram users who report employment at the Home Depot.  Other work shows that Facebook-reported age and gender appear quite accurate [@grow_is_nodate]. I use raking weights for the descriptive quantities, but use the unweighted sample when analyzing the survey experiment.
...
Our preferred measure of awareness comes from a list of eight work-related benefits or programs presented to respondents.^[I discuss two other indicators of awareness and compare them with the preferred "list" measure in \@ref(app-HFaware).]  They were asked to select all available to "workers like you." Among the possible programs was "cash grants to help in times of emergency."  The proportion of respondents selecting this answer provides a measure for EHF awareness available for all survey respondents without contaminating the later survey experiment.  I estimate that `r 100*round(aware_tab$aware.prop.l,2)`% (se = `r 100*round(aware_tab$aware.prop.l_se,2)`%) were aware of a cash grant program.  
...
In the experiment were a control condition and two treatment arms, referred to as the _text_ and _video_ treatments, respectively.  Respondents in the control arm saw no prompt or mention of the EHF.  Those in the text treatment were presented with a neutral, factual statement about their employer's EHF.  The prompt can be interpreted as reminding or priming respondents about the EHF program. Specifically, the treatment was:
...
Do the results from Study 2 replicate at other large US retailers?  Or is the Home Depot something of an outlier?  Based on the results from Study 2, we conducted a third study, this time focusing on Walmart workers.  As another publicly traded, "big box" retailer, work practices and conditions at Walmart will be similar to the Home Depot. The two firms compete to some degree, including over workers.  Walmart has also seen union activism in some locations. Walmart is the largest retailer (and private sector employer) in the United States, over three times as large the Home Depot in employee headcount, making the social media recruitment strategy feasible.  With its size and ubiquity, Walmart employment benefits, programs, and procedures have an impact on the retail industry as a whole. 

As with the HF, Walmart's ACNT Together Fund is over 20 years old and managed in-house.  The EHF is available to both full- and part-time workers who have been at Walmart for at least one year.  As of 2021, ACNT claims to have disbursed over \$142 million to over 145,000 employees.  But the ACNT is substantially less generous than the HF and operates on a smaller scale, notwithstanding Walmart's considerably larger presence. And Walmart appears to engage in less internal promotion around its EHF.^[Interestingly, Walmart matches employee donations to the Walmart political action committee 2:1 with corporate donations to the Together Fund.  This was challenged but found legal by the Federal Election Commission in 2015.]  The ACNT Together Fund has a minimal social media presence.  Interviews with practitioners in the field also concurred that Walmart is perceived as less aggressive than the Home Depot in generating engagement with its EHF.    

In fielding a survey of Walmart workers, I followed the same social media recruitment strategy as with the Home Depot.  Survey completers were offered the opportunity to enter a raffle for a $400 gift card.  The survey was in the field from XXX to XXX and produced `r nrow(wmt)` complete responses that passed screener and attention checks.  We produce raking weights for the Walmart sample in a manner analogous to the Home Depot and employ them below in the same way.

The surveys in Studies 2 and 3 were very similar in question wording and ordering, but there were four main extensions in Study 3:  we asked about quit intentions; we included a behavioral measure of donation to the EHF (clicking on a link to a donation page); we expanded the EHF survey experiment; and we sent a follow-up survey one week after survey completion to respondents who opted in to the incentive raffle.^[Respondents were sent emails to invite them into the follow-up survey, offering them a second entry into the raffle for follow-up completion.  Respondents were contacted a maximum of three times. We received valid followup responses from `r sum(!is.na(wmt$age_f))` or `r round(100*sum(!is.na(wmt$age_f)) /nrow(wmt))`% of those completing the main survey.] 

### Survey experiment 

Based on the findings from the Home Depot, the experiment in the Walmart survey used only a video vingette treatment.  To make the video treatments as similar as possible across settings, I used the HF video as a script and visual template to then produce an original video adapted to the Walmart context using a paid actor.  The paid actor exhibited the same gender (male) and racial (white) expression as in the HF video.  The actor was also viewed as approximately the same age as the HF spokesperson, according to mTurk coders.^[The ACNT-adapted video was 41 seconds shorter than the HF video.  We achieved this by shortening or removing some interstitial and panning shots, not through any reduction in the spoken script beyond those parts that were only relevant to the Home Depot.  We also included text indicating that the speaker was an actor at the beginning of the video.]    

Respondents were randomly assigned to either treatment or control.  Within the control condition, respondents were randomly divided between the pure control and the placebo conditions.  The pure controls saw no additional information, just as in Study 2.  Respondents in the placebo condition watched a video in which the hired actor delivered a Walmart press release about the company's acquisition of Vizio.^[I also pre-registered a framing study, in which I slightly vary the framing of the treatment video.  Specifically, the "card" visible before the respondent clicks "play" differs, with the _solidarity_ framing presenting text emphasizing supporting other Walmart workers and the and the _charity_ framing displaying text emphasizing charitable donations to help those in need. The content of the video vingettes was otherwise identical across treatment groups.  As there was no detectable difference between these framings, I do not report on this in the main text.  Regression results demonstrating this for key outcomes appears in appendix [cite appendix].]  A manipulation check (see Appendix XX) confirms that the video treatment did, indeed increase respondent awareness of the ACNT, as expected.  There were no detectable differences between pure control and placebo groups in their (non-)effect.  Thus we display results for binary treatment/control in the analysis below. 


## Attachment
We then construct an attachment index by taking the first principal component from a PCA across these items, scaled so that larger values indicate greater attachment.  We analyze the various components of the attachment in  that  
