...
\midrule
\cellcolor{gray!10}{All} & \cellcolor{gray!10}{Covariate specifications} & \cellcolor{gray!10}{In some of the covariate specifications, we include measures of partisanship, political ideology, home ownership, and state of residence.  These are included in addition to pre-registered specifications to specifically connect with the existing literature.}\\
...
\caption{Multimodal Similarity: Walmart Treatment vs. Walmart Placebo}\label{fig:unnamed-chunk-2}
\end{figure}
...
\centering
\begin{talltblr}[         %% tabularray outer open
caption={Support for other social policies, OLS regression  \label{tab:tab-placebo}},
note{}={* p \num{< 0.1}, ** p \num{< 0.05}, *** p \num{< 0.01}},
