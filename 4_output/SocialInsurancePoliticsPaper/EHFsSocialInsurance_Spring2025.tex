...
\centering
\begin{talltblr}[         %% tabularray outer open
caption={Support for unemployment insurance and emergency government aid (Walmart)  \label{tab:tab-ui-hard-wmt}},
note{}={* p \num{< 0.1}, ** p \num{< 0.05}, *** p \num{< 0.01}},
note{ }={Standard errors in parentheses.
...
hline{2}={1-5}{solid, black, 0.05em},
hline{1}={1-5}{solid, black, 0.08em},
hline{48}={1-5}{solid, black, 0.08em},
column{2-5}={}{halign=c},
cell{1,3-24,26-47}{1}={}{halign=l},
cell{2,25}{1}={c=5}{halign=l},
}                     %% tabularray inner close
& Base & Pre-exposed & Pre-registered & Expanded \\
DV: Unemployed & DV: Unemployed & DV: Unemployed & DV: Unemployed & DV: Unemployed \\
Treated & 0.016 & 0.018 & 0.016 & 0.007 \\
& (0.014) & (0.017) & (0.018) & (0.016) \\
Pre-exposed &  & 0.003 & 0.007 & -0.001 \\
&  & (0.020) & (0.020) & (0.014) \\
Treated x pre-exposed &  & -0.005 & -0.005 & 0.006 \\
&  & (0.028) & (0.028) & (0.028) \\
Past welfare &  &  &  & 0.013 \\
&  &  &  & (0.016) \\
HH income &  &  &  & -0.000 \\
...
Religiosity &  &  &  & 0.003 \\
&  &  &  & (0.013) \\
State safety net generosity &  &  &  & -0.008 \\
&  &  &  & (0.006) \\
Conservative &  &  &  & -0.061*** \\
&  &  &  & (0.017) \\
house appreciation &  &  &  & -0.000*** \\
&  &  &  & (0.000) \\
Std Errors & robust & robust & robust & state-clustered \\
$N$ & 980 & 980 & 980 & 913 \\
$R^2$ & 0.00 & 0.00 & 0.01 & 0.05 \\
AIC & -222.9 & -219.0 & -216.2 & -209.3 \\
DV: Emergency & DV: Emergency & DV: Emergency & DV: Emergency & DV: Emergency \\
Treated & 0.019 & 0.012 & 0.012 & -0.002 \\
& (0.013) & (0.017) & (0.017) & (0.015) \\
Pre-exposed &  & -0.007 & -0.005 & -0.015 \\
&  & (0.019) & (0.020) & (0.020) \\
Treated x pre-exposed &  & 0.017 & 0.014 & 0.026 \\
&  & (0.027) & (0.027) & (0.025) \\
Past welfare &  &  &  & 0.016 \\
&  &  &  & (0.017) \\
HH income &  &  &  & -0.000 \\
...
Religiosity &  &  &  & -0.017 \\
&  &  &  & (0.011) \\
State safety net generosity &  &  &  & -0.004 \\
&  &  &  & (0.007) \\
Conservative &  &  &  & -0.057*** \\
&  &  &  & (0.020) \\
Std Errors & robust & robust & robust & state-clustered \\
...
&  &  &  & (0.000) \\
$N$ & 980 & 980 & 980 & 913 \\
$R^2$ & 0.00 & 0.00 & 0.01 & 0.04 \\
AIC & -320.9 & -317.3 & -313.4 & -299.2 \\
\end{talltblr}
\end{table}
...
\centering
\begin{talltblr}[         %% tabularray outer open
caption={ACNT donation willingness (Walmart sample) \textbackslash{}label\{tab:tab-donate-wmt\}},
note{}={* p \num{< 0.1}, ** p \num{< 0.05}, *** p \num{< 0.01}},
note{ }={Standard errors in parentheses.
 Pre-registerd covariates include age, gender race, job tenure, hourly status, full time status, college degree, and main job.},
]                     %% tabularray outer close
...
\centering
\begin{talltblr}[         %% tabularray outer open
caption={Regression of ACNT donation on treatment  \textbackslash{}label\{tab:tab-donate-models-wmt-app\}},
note{}={+ p \num{< 0.1}, * p \num{< 0.05}, ** p \num{< 0.01}},
note{ }={Robust standard errors for OLS model},
]                     %% tabularray outer close
{                     %% tabularray inner open
colspec={Q[]Q[]Q[]Q[]},
