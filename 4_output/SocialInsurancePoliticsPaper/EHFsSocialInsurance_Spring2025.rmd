...
Figure \@() displays the distributions of both EHF outcomes against safety net generosity, measured in US dollars. Inspection of the graphs suggests that there is no relationship between safety net generosity and either support for or willingness to donate to an EHF. 

```{r fig-ui-genretail, echo=FALSE, fig.cap = "EHF support and willingness to donate to a potential new EHF, by State level welfare benefits in USD. Marginal distributions of the variables are included as blue histograms.", fig.subcap = c("Support", "Willingness to Donate"), out.width="50%", fig.align = "center"}
