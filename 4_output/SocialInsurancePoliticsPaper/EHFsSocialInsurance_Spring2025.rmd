...
This paper builds on two largely disconnected literatures, both arguing that government welfare programs and private resources substitute for one another.  The first is an argument that goes back to at least the 18th Century, in which government spending, especially on social welfare and insurance, crowds out private charitable giving as well as private savings.  The second, more recent literature, works in the opposite direction, linking improved access to private financial resources to reduced voter support for broad welfare and social insurance programs.
...
As the welfare state expanded dramatically in the post-War period, these arguments were revived [@friedmanCapitalismFreedom2002].  @feldsteinSocialSecurityInduced1974 argued that Social Security depressed household private savings by 30-50%, spawning an ongoing debate about the scale of substitution [@alessiePensionWealthHousehold2013].  Theoretical work based on the assumption the charitable contributions are a public good, suggested that government spending should crowd out private charity to some degree [@andreoniImpureAltruismDonations1990; @warrParetoOptimalRedistribution1982; @bergstromPrivateProvisionPublic1986].  Subsequent work centered on estimating the the scale of this substitution effect to determine whether government spending crowds out private giving dollar-for-dollar (as in models of "pure altruism") or at some lesser rate ("impure altruism").  A variety of empirical contexts and research designs produced widely varying estimates, including some evidence of "crowding in" [@dewitGovernmentSupportCharitable2016; @bredtmannDoesGovernmentSpending2023; @andreoniCharitableGiving2013].^[Crowding-in is particularly in studies of government grants to specific charities, which may signal need or charity quality.  This particular line of reasoning is not relevant to this paper.  A more interesting possibility is that government spending is a signal (or byproduct) of a broader "culture of care".  Lab experimental studies tend to provide the largest estimates of crowding out.]  Most relevant to this study, @hungermanAreChurchState2005a and @gruberFaithbasedCharityCrowdout2007 exploit 20th Century variation across US Stated (as we do below), estimating that government social welfare spending reduces charitable relief from churches by about 30%. @boberg-fazlicDoesWelfareSpending2017 find the parish-level spending on poor relief *increases* charitable spending in early-19th Century England.

At this stage, the large weight of empirical evidence rules out dollar‑for‑dollar crowd‑out between government spending and charitable contributions, but otherwise there remains controversy.  In some of the most well-identified studies, charitable organizations crucially intervene between donations and service provision, complicating interpretation.  For example, fundraising effort responds strategically to government support [@andreoniCrowdingOutDue2011].    Research looking at looks at actual government spending, as opposed to the spending "regimes" or institutions in place.  This is a significant conflation, as @esping-andersenThreeWorldsWelfare1990 noted decades ago.^["Expenditures are epiphenomenal to the theoretical substance of welfare states." [@esping-andersenThreeWorldsWelfare1990] p.19] 

The rise of crowdfunding platforms has provided some evidence around individual donation behavior and government policy.  @panjwaniCausesConsequencesMedical2023 show that health-related crowdfunding GoFundMe campaigns declined after expansions in medical insurance coverage due to the  Affordable Care Act, although this could be a demand effect.  @leeNewDigitalSafety2022 show that areas with poor private insurance coverage and fewer social associations see greater initiation rates for GoFundMe campaigns, but campaigns in these same areas are less likely to be successful.  @bernardOutCrowdingEffects2025 show that the degree of excludability matters.  Crowd-funding projects with low excludability (i.e., you do not need to donate to enjoy benefits, should the project go forward) exhibit the most crowding out from past donations.  EHFs are non-excludable in that there is no requirement to have donated in order to apply for benefits. 
...
### What about crowding in?

@kotchenCrowdingImpureAltruism2023.  Increase in NP funding leads to more volunteer labor

Government funding as a signal of project quality or viability is not relevant here.
...
@werfelDoesCharitableGiving2018 perception of charitable resources reduces support for gov't spending

On the one hand, public programs often step in when private mutual aid or insurance pools collapse.  One example is the famous "Ghent system," in which unions administer government-mandated unemployment insurance.  These systems, common in Northern Europe, emerged from early unemployment and injury insurance programs run as mutual aid pools founded by trade unions.  Government underwriting of social insurance through taxation grew out of the repeated collapse (and ad hoc bailouts) of these privately-organized welfare and mutual aid pools [@socialsecurityadministrationSocialSecurityHistory2023; @western_1997].

A more recent literature points to a different dynamic: (perceived) improvements in private resources can crowd out support for government social insurance and welfare programs. The logic is simple: voters perciving an improved personal financial position are more confident in their ability to "self-insure" against negative income shocks while also becomeing less willing to pay taxes into the public system.  @ansell_political_2014 focuses on homeownership, finding that American and British voters with appreciating real estate assets are less supportive of social insurance.  @wiedemann_how_2022 and @ahlquistTakingCreditRedistribution2017 focus on easy access to credit as a key private resource that can affect support for redistributive policy  [; @busemeyer_welfare_2020; @rosner_struggle_2003; @hacker_insecure_2013; @zhu_policy_2015] .  
