...
output: 
  bookdown::pdf_document2:
    ...
    extra_dependencies: ["hyperref", "bbm", "subfig", "flafter", "float"]
...
study_table <- tibble(
  ...
  Rationale = c(
    "In some of the covariate specifications, we include measures of partisanship, political ideology, home ownership, and state of residence.  These are included in addition to pre-registered specifications to specifically connect with the existing literature.",
