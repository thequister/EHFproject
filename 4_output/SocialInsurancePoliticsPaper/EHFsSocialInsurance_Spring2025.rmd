...
Big literature on government spending crowding out savings and charity.  Another literature on how more private resources reduce support for the welfare state and redistribution.  Policy feedback literature too. No work that actively studies how variation in employer-provided benefits might relate to political attitudes and activities.  This is shocking, given the tremendous leeway firms have to introduce, revise, and eliminate everything from   Simlarly, there is no work on whether government social spending affects support for workplace benefits ^[There is some work that looks at whether having workplace benefits like health insurance affects support for reforms such as the affordable care act. (cites) ] 

EHFs great because they are workplace programs that combine both insurance and charitable aspects.
...
^[Note that a companion piece, @ahlquistPrivateWelfareCorporate2025, also draws on these same data for different outcomes.  Descriptions of the survey and survey experiment are largely identical in the two papers.]

# The "substitution hypothesis," two ways

This paper builds on two largely disconnected literatures, both of which are concerned with whether private resources and public welfare and social insurance substitute for one another.  The first originates from claims, dating from at least the 18th Century, about how government spending on poor relief, welfare, and social insurance crowds out private charitable giving and private savings.  The second and more recent literature works in the opposite direction.  It focuses on the links between improved access to private financial resources---credit, appreciating assets, insurance---and reduced voter support for public welfare and social insurance programs.  
...
In examining social insurance, we take a question battery from the General Social Survey that asks respondents to report how much responsibility the government should have for ensuring the welfare of different constituencies.  Here I examine responses for "the unemployed" (4-category response ranging from "none at all" to "a lot").  This is a commonly used question for gauging attitudes toward government social insurance in general [find cites].  We refer to other responses in this same battery below.
